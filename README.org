...
* Installation
This package is not available at MELPA, yet. You can clone this repository, e.g., at a specific release tag and add the directory to your loadpath.

* Configuration
Using ~use-package~:
#+begin_src emacs-lisp
  (add-to-list 'load-path "~/git/cypher-ts-mode")
