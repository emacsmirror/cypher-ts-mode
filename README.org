...
- Font lock configuration, keywords defined according to [[https://github.com/opencypher/openCypher/blob/main/cip/0.baseline/openCypher9.pdf][Cypher Query Language Reference, Version 9]]
